...
export default function classicStandingsBackwardsCompatibility(standings) {
  return {
    leagueId: standings.data.draftLeague.leagueInfo.id,
    leagueName: standings.data.draftLeague.leagueInfo.name,
    lastUpdated: standings.data.draftLeague.leagueInfo.lastUpdated,
    gwEnded: standings.data.draftLeague.leagueInfo.gameweekEnded,
    players: standings.data.draftLeague.entries.map((entry) => {
      const players = getPlayers(entry, standings.data.draftLeague.players);
