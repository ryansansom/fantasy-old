...
export const playerType = new GraphQLObjectType({
  ...
  fields: {
    ...
    expectedPoints: { type: GraphQLFloat },
    expectedPointsNext: { type: GraphQLFloat },
    provisionalBonus: { type: GraphQLInt },
    actualBonus: { type: GraphQLInt },
    gamesStarted: { type: GraphQLBoolean },
    gamesFinished: { type: GraphQLBoolean },
    pointsFinalised: { type: GraphQLBoolean },
    minutesPlayed: { type: GraphQLInt },
  },
});
