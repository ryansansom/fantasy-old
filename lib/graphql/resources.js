...
import DraftLeagueInfo from './draft-league-info';

export default class ResourceLoader {
  constructor(rootValue) {
    this.args = rootValue.args;
    this.resources = rootValue.resources;
    this.draft = rootValue.draft; // TODO: Should this be an arg?
  ...
  draftLeagueInfo = () => {
    if (!this._allDraftLeagues) {
      this._allDraftLeagues = new DraftLeagueInfo(this);
    }

    return this._allDraftLeagues;
  };
